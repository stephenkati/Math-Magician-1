 ...
 **[Math Magician]** is a project that lets you make simple mathematic calculations and uses an API to display some motivational quotes.
...
go to https://github.com/stephenkati/Math-Magician-1.git
...
Run `git clone https://github.com/stephenkati/Math-Magician-1.git`
...
Feel free to check the [issues page](https://github.com/stephenkati/Math-Magician-1/issues).
